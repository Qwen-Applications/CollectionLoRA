...
def fsdp_wrap(module, sharding_strategy="full", mixed_precision=False, wrap_strategy="size", min_num_params=int(5e6), transformer_module=None,ignored_modules=None):
    if mixed_precision:
    ...
    module = FSDP(
        ...
        ignored_modules=ignored_modules, # allow some modules to be ignored 
    )
    return module
